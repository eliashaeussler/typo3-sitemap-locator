...
namespace EliasHaeussler\Typo3SitemapLocator\Tests\Functional;
...
trait ClientMockTrait
{
    ...
    private function registerMockHandler(): void
    {
        ...
        $this->eventDispatcher->addListener(
            Src\Event\BeforeClientConfiguredEvent::class,
            function (Src\Event\BeforeClientConfiguredEvent $event): void {
